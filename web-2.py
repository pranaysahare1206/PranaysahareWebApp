...
with st.sidebar:
    selected = option_menu(
        menu_title=None,
        options=['Home', 'Projects', 'Certificate','Contact'],
...
if selected == "Certificate":
    ...
    with st.container():
        ...
        with st.container():
            ...
            with text_column:
                ...
                st.markdown(
                    "[Show Credential](https://www.udemy.com/certificate/UC-df50760d-f338-4a86-9ba7-715a28fa9b24/)")
        ...
        with image_column:
            ...
            with text_column:
                ...
                st.markdown(
                    "[Show Credential](https://www.udemy.com/certificate/UC-c8cf18fc-62dc-4bb9-a6b5-45b3e0eb3e37/)")
        ...
        with st.container():
            ...
            with text_column:
                ...
                st.markdown(
                    "[Show Credential](https://www.udemy.com/certificate/UC-8c3f3f49-91c2-4a4c-b29a-67911df7e8ec/)")
    ...
    with st.container():
        ...
        st.write("##")
        image_column, text_column = st.columns((1, 2))
        st_lottie(empty, height=500, key="empty")

    with st.container():
        st.write("---")
        st.header("[section empty]")
        st.write("##")
...
if selected == "Contact":
    with st.container():
        ...
        <form action="https://formsubmit.co/p5202102@gmail.com" method="POST">
            ...
            <textarea name="message" placeholder="Your maessade here" required></textarea>
        ...
        with right_column:
            st_lottie(contact, height=500, key="contact")
